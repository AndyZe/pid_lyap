...
#include "pid_lyap/lyap_controller.h"
...
int main(int argc, char **argv)
{
  ...
  ROS_INFO(" ");
  ROS_INFO("Also check the parameters of the controller at the top of pid_lyap/src/controller.cpp");
  ...
  ros::Publisher chatter_pub = controller_node.advertise<pid_lyap::controller_msg>("control_effort", 1);
